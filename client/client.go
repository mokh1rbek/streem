...
func main() {
	...
	c := pb.NewCalculatorServiseClient(conn)
...
func DoUnary(c pb.CalculatorServiseClient) {
	...
	fmt.Println("sqr: ", res.GetSqrNumber())
}

func DoServerStreaming(c pb.CalculatorServiseClient) {
...
func DoClientStreaming(c pb.CalculatorServiseClient) {
...
func DoBiDirectionalStream(c pb.CalculatorServiseClient) {
	...
	go func() {
		numbers := []int32{4, 6, 2, 23, 13, 7, 8, 53, 1, 0, -5, -4, -6}
